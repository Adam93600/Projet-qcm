...
Description :
Le qcm est une solution d'urgence pour pallier l'arrêt de Moodle à l'approche des partiels. Ce projet propose un système complet fonctionnant dans un terminal. Il offre une plateforme simple permettant aux professeurs de créer des évaluations et aux étudiants de les passer, le tout avec un système de sauvegarde persistant.
